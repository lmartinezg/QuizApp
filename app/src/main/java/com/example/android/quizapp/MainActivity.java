...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Process answers (previous version)
     */
    public void onSendButtonV0(View view) {
        ...
        // For Question 1 - Radio button - Correct: D
        questionNumber = 1;
        rg = (RadioGroup) findViewById(R.id.q1_radio_group);
        checked = rg.getCheckedRadioButtonId();
        if (checked == -1) {
            noAnswer = true;
            Toast.makeText(this, getString(R.string.err_no_answer, questionNumber), Toast.LENGTH_SHORT).show();
        } else if (checked == R.id.q1_radio_button_D) {
            results[questionNumber - 1] = 1;
        }

        // For Question 2 - Radio button - Correct: A
        questionNumber = 2;
        rg = (RadioGroup) findViewById(R.id.q2_radio_group);
        checked = rg.getCheckedRadioButtonId();
        if (checked == -1) {
            noAnswer = true;
            Toast.makeText(this, getString(R.string.err_no_answer, questionNumber), Toast.LENGTH_SHORT).show();
        } else if (checked == R.id.q2_radio_button_A) {
            results[questionNumber - 1] = 1;
        }

        // For Question 3 - EditText - Correct: question_3_correct_answer
        questionNumber = 3;
        et = (EditText) findViewById(R.id.q3_edit_text);
        etText = et.getText().toString();
        if (etText.equals("")) {
            noAnswer = true;
            Toast.makeText(this, getString(R.string.err_no_answer, questionNumber), Toast.LENGTH_SHORT).show();
        } else if (etText.toUpperCase().equals(getString(R.string.question_3_correct_answer).toUpperCase())) {
            results[questionNumber - 1] = 1;
        }

        // For Question 4 - EditText - Correct: question_4_correct_answer
        questionNumber = 4;
        et = (EditText) findViewById(R.id.q4_edit_text);
        etText = et.getText().toString();
        if (etText.equals("")) {
            noAnswer = true;
            Toast.makeText(this, getString(R.string.err_no_answer, questionNumber), Toast.LENGTH_SHORT).show();
        } else if (etText.toUpperCase().equals(getString(R.string.question_4_correct_answer).toUpperCase())) {
            results[questionNumber - 1] = 1;
        }

        // For Question 5 - CheckBoxes - Correct: B and C
        questionNumber = 5;
        q5CbA = (CheckBox) findViewById(R.id.q5_check_box_A);
        q5CbB = (CheckBox) findViewById(R.id.q5_check_box_B);
        q5CbC = (CheckBox) findViewById(R.id.q5_check_box_C);
        if ((!q5CbA.isChecked()) &&
                q5CbB.isChecked() &&
                q5CbC.isChecked()) {
            results[questionNumber - 1] = 1;
        ...
        // For Question 6 - RadioButton - Correct: A
        questionNumber = 6;
        rg = (RadioGroup) findViewById(R.id.q6_radio_group);
        checked = rg.getCheckedRadioButtonId();
        if (checked == -1) {
            noAnswer = true;
            Toast.makeText(this, getString(R.string.err_no_answer, questionNumber), Toast.LENGTH_SHORT).show();
        } else if (checked == R.id.q6_radio_button_A) {
            results[questionNumber - 1] = 1;
        }
